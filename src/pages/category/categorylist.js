...
import { getCategory, save, removeCategory } from '../../actions/category';
...
const Categorylist = function (props) {
    ...
    let saveChanges = (e) => {
        ...
        if (name == "") {
            setValidateMessage('please enter category name');
            return;
        }
        if (admin == "") {
    ...
    async function finalDeletePopup() {
        try {
            ...
            if (response.data.deletedCount > 0) {
                ...
                // setAlert({type:'success', message : 'You have remove category successfully'})
                getAllCategory();
            }
                                ...
                                <Widget>
                                    <div className={s.tableTitle}>
                                        ...
                                        <div className="d-flex">
                                            <button type="submit" className="mr-3 mt-3 btn btn-primary" onClick={(event) => categoryform(event)}>Add New Category</button>
                                        </div>
                                    </div>
                            ...
                            <Col>
                                <Widget>
                                    <div className={s.tableTitle}>
                                        ...
                                        <div className="d-flex">
                                            <button type="submit" className="mr-3 mt-3 btn btn-primary" onClick={(event) => viewList(event)}>Category List</button>
                                        </div>
                                    </div>
